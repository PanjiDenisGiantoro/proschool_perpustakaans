      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6 mt-2">
            <h1 class="m-0 text-dark" style="text-shadow: 2px 2px 4px white;"><i class="nav-icon fas fa-th"></i></i> <?php echo $judul; ?></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
                ...
                <table id="datatb" class="table table-bordered table-hover table-striped table-sm">
                  ...
                  foreach($siswa->result_array() as $data) { ?>
                    <tr style="text-align:center;">
                      ...
                      <td class="text-sm" style="text-align:left;"><?php echo $data['s_siswa']; ?></td>
