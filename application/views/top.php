...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed ">
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand  navbar-light" style="background-color: white;">
      ...
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link" data-widget="pushmenu" href="#"><i class="fas fa-bars text-navy"></i></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="<?php echo base_url(); ?>app/home" target="_blank"><i class="fas fa-spin fa-globe text-navy"></i></a>
        </li>
        <li class="nav-item">
      <span class="brand-text-shadow"><font color='black'><center style="font-size: 25px;">PERPUSTAKAAN</span></font></center>
          <!-- <a class="nav-link" href="<?php echo base_url(); ?>app/home" target="_blank"><i class="fas fa-spin fa-globe text-navy"></i></a> -->
        </li>
      </ul>
      <ul class="animated  navbar-nav ml-auto">
      <div class="btn-group btn-group-sm">
                    <span class="btn icon text-white-50" style="background-color: #2B303B">
                      <i class="fas fa-calendar-alt text-white"></i>
                    </span>
                    <span class="btn  brand-text font-weight-light text-white text-uppercase"><b><font color="black">TA : <?php echo $tahun_ajaran->tahun_ajaran.' | Semester '.$tahun_ajaran->semester; ?></b></font></span>
