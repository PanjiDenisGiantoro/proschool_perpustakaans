...
<body class="hold-transition layout-top-nav" onLoad="openFullscreen ()"; allow="fullscreen">
<div class="wrapper">	
  <!-- /.navbar -->
	<div class="row">
          <div class="col-md-12">
            <div class="card card-widget widget-user">
              ...
              <div class="widget-user-header" style="background-color: #2D5E89">

				  <?php
				  $sekolah = $this->db->query("SELECT * FROM sr_profile WHERE idprofile = 1")->row();
				  ?>
				  <img src="<?php echo 'http://'.$_SERVER['SERVER_NAME'].'/assets/upload/profile/thumbnails/'.$sekolah->pr_logo; ?>" alt="Logo" class="brand-image img-rounded " style="width:60px;height:60px;">

				  <!--              <img width="60px" height="60px" src="--><?//=base_url('upload/d2519ba5637fadf30e648ce751c9bc31.png')?><!--">-->
                <h3 class="widget-user-username text-white"><b>PERPUSTAKAAN</b></h3>
                <h6 class="widget-user-desc text-white"><b><?php echo $pr_nama; ?></b></h6>
              </div>
         
              <!-- <div class="widget-user-image">
                <img class="img-rounded elevation-2" src="<?php echo 'http://'.$_SERVER['SERVER_NAME'].'/upload/'.$sekolah->logo; ?>" alt="User Avatar">
              </div> -->
			            ...
			            <div class="card card-navy">
			              <div class="card-header">
			                ...
			                <div class="card-tools">
			                  <button type="button" class="btn btn-tool" onclick="openFullscreen();"><i class="fas fa-expand"></i>
			                  </button>
			                </div>
			                <!-- /.card-tools -->
			              </div>
			                ...
			                <form action="<?php echo base_url(); ?>app/save_pengunjung" method="post">
								...
								<div class="input-group mb-3">
				                  ...
				                  <div class="input-group-prepend">
				                    <a class="btn bg-navy cari-siswa" href="#"><i class="fa fa-search"> </i> </a>
				                  </div>
				                </div>
								...
								<div class="form-group text-center">
									<button class="btn bg-navy" style="width:100%;"> <i class="fa fa-save"> </i> Simpan</button>
								</div>
							</form>
			              </div>
			              <!-- /.card-body -->
 ...
 <!--  <footer class="main-footer text-center" >
        <?php echo "Copyright © " ."". (int)date('Y');?> 
        <a href="http://prodoc.id" target="_blank">
          <b>ProSchool
          </b>
        </a>. All rights reserved. Version. 1.0
      </footer> -->
<!-- </div> -->
<!-- ./wrapper -->
