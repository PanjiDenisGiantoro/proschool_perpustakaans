...
class Home extends CI_Controller {
	...
	public function index() {
		...
		// if($this->session->userdata('hak_akses') != "") { 
			...
			// $hitung_pengembalian = $this->db->query("SELECT COUNT(*) as hitung FROM mst_buku")->row();



			$hitung_pengembalian = $this->db->query("SELECT SUM(jumlah) as hitung FROM peminjaman_buku_dt WHERE tanggal_kembali")->row();
			...
			$d['hitung_pengembalian'] = $hitung_pengembalian->hitung;
